...
namespace Hunghbm\FedEx\Providers;

use Illuminate\Support\ServiceProvider;
use Illuminate\Foundation\AliasLoader;
use Hunghbm\FedEx\Shipping;
use Hunghbm\FedEx\Facades\Shipping as ShippingFacade;
...
class FedExServiceProvider extends ServiceProvider {
    ...
    public function boot()
    {
        ...
        $this->loadTranslationsFrom(__DIR__ . '/../Resources/lang', 'hunghbm');
    }
